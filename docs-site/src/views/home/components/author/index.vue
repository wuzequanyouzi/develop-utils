<template>
  <div class="author-wrap author">
    ...
    <div class="information">
      <span @click="handleClick('https://juejin.cn/user/1187128290064439/posts')">
        <svg
          t="1696843080965"
          class="icon"
      ...
      <span @click="handleClick('https://github.com/wuzequanyouzi')">
        <svg
          t="1696843254608"
          class="icon"
